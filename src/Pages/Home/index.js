...
export default class Home extends Component {
 ...
 componentWillUnmount() {
   ...
   klikSimpan() {
	       var cari = this.state.cari;
		   	 var nama = this.props.route.params.nama;
 var iduser = this.props.route.params.iduser;
 this.props.navigation.navigate('Caribuku',{cari :cari,iduser:iduser,nama:nama})}  
 ...
 Selamat Datang {nama}{iduser}  
             ...
             <View style={styles.rowicon}>
			 
			  {
                this.state.listData1.map((val,index)=>(
                   <TouchableOpacity  onPress={() => this.props.navigation.navigate('Buku',{id :val.id, iduser:iduser,
  ...
  <Text style={{textAlign: 'center', fontSize: 16 ,color: "red", width:'200'}}>
			  ...
			  {val.judul_buku}{val.ket}{val.harga}
    ...
    justifyContent: 'center',
		  ...
		  <View
              ...
              <View
                ...
                <TouchableOpacity
                  onPress={() =>this.props.navigation.replace('Profil',{nama:nama, iduser:iduser}  )}>
                  <Image
                    source={IconProfilku}
                    style={{
                      width: 25,
